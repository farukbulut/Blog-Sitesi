...
<head>
    ...
    <title>Blog Sitesi Admin Login</title>
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="{{route('admin.login.post')}}">
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email"  class="form-control form-control-user"  aria-describedby="emailHelp" placeholder="Email Adresi...">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control form-control-user" placeholder="Şifre">
                                    </div>
                                    <div class="form-group">
